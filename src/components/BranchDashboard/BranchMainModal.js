              ...
              <Grid item key={card.ReplacmentCode} >
                <Card className={classes.card}>
                  ...
                  >
                    ...
                    <ReqTrainers approveTrainer={approveTrainer} declineTrainer={declineTrainer} req={requests.filter((val)=>(val.ReplacmentCode === reqCode && val.RequestStatus === "open" && val.IsAprrovedByTrainer ==="true"))}/>
                    </div>                  
                  </Modal>
                  </CardActions>
                </Card>
            ...
            {requests && requests.filter((card)=>(card.IsHistory===false && card.IsAprrovedByTrainer === "true" && card.RequestStatus === "approved" )).map((card) => (
              <Grid item key={card.ReplacmentCode} >
                <Card className={classes.card}>
                  ...
                  >
                    <div style={modalStyle} className={classes.paper}>
                    <ReqTrainers approveTrainer={approveTrainer} declineTrainer={declineTrainer} req={requests.filter((val)=>(val.ReplacmentCode === card.ReplacmentCode && val.RequestStatus === "approved" && val.IsAprrovedByTrainer ==="true"))}/>
                    </div>                  
                  </Modal>
                  </CardActions>
                </Card>
