      ...
      <main>
        <Container className={classes.cardGrid} maxWidth="md">
          ...
          <Grid container spacing={4}>
            <Grid item xs={12}><h4 style={{textAlign:'right'}}>בקשות החלפה חדשות שטרם נענו</h4></Grid>
            {requests && requests.sort((a, b) => a.ReplacementDate > b.ReplacementDate ? 1 : -1).filter((card)=>(card.IsHistory===false && card.IsAprrovedByTrainer == "initial" && card.RequestStatus == "open")).map((card) => (
